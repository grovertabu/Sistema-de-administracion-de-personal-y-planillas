        ...
        <div class="col-md-7">
            <div class="card card-primary ">
                <div class="card-header">
                    <h3 class="card-title">Generar Planilla de Fondo de Empleados</h3>
                </div>
                <form action="{{ route('fondo_empleado.generar_planilla') }}" method="POST" class="create" role="form"
                    id="form_all_fondo_empleado">
                    @csrf
                    <div class="card-body row">
                        ...
                        <x-input type="text" name="porcentaje_fe" id="porcentaje_fe" label="Porcentaje descuento(%)"
