...
@section('title', 'Bono Antiguedad')

@section('content_header')
    <h1>Consultar Bono de Antiguedad</h1>
@stop
...
@section('content')
    ...
    <div class="card card-secondary card-outline">
        <div class="justify-content-center row" style="height:250px;width:100%">
            <form class="form-inline" action="{{ route('bono_antiguedad.lista') }}" method="GET">
                {{-- @csrf --}}
                {{-- <div class="form-group mx-sm-3 ">
                    ...
                    <select class="form-control @error('tipo_contrato') is-invalid @enderror"
                        name="tipo_contrato" id="tipo_contrato">
