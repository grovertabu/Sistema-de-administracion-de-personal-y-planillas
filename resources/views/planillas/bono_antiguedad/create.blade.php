...
@section('title', 'Crear Bono de antiguedad')
        ...
        <div class="col-md-7">
            <div class="card card-primary ">
                <div class="card-header">
                    <h3 class="card-title">Crear Bono de antiguedad individual</h3>
                </div>
                <form action="{{ route('bono_antiguedad.generar_bono_antiguedad') }}" method="POST" class="create" role="form"
                    id="form_all_bono_antiguedad">
                    @csrf
                    <div class="card-body row">
                        ...
                        {{-- Trabajadores que no tenga bono_antiguedad --}}
