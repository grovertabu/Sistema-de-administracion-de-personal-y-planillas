...
@section('title', 'Crear Planilla General')
@php
        ...
        <div class="col-md-7">
            <div class="card card-primary ">
                <div class="card-header">
                    <h3 class="card-title">Cargar Planilla</h3>
                </div>
                <form action="{{ route('planilla.generar_planilla') }}" method="POST" class="create" role="form"
                    id="form_all_total_ganado">
                    @csrf
                    <input type="hidden" name="nombre_planilla_id" value={{$nombre_planilla->id}}>
                    <div class="card-body row">
                        ...
                        <x-input type="text" name="nombre_planilla" id="nombre_planilla" label="Nombre" readonly="true"
                            topclass="col-md-12 required" value="{{ old('nombre_planilla', $nombre_planilla->nombre_planilla) }}" />
                    </div>
