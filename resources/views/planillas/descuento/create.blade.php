...
@section('title', 'Crear Aporte laboral')
        ...
        <div class="col-md-7">
            <div class="card card-primary ">
                <div class="card-header">
                    <h3 class="card-title">Crear Aporte laboral individual</h3>
                </div>
                <form action="{{ route('descuento.generar_descuento') }}" method="POST" class="create" role="form"
                    id="form_all_descuento">
                    @csrf
                    <div class="card-body row">
                        ...
                        {{-- Trabajadores que no tenga descuento --}}
