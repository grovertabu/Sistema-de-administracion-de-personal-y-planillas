<form method="POST" class="create" role="form" id="formCambiarConsultor">
    <div class="modal-dialog modal-custom modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Cambiar Consultor</h5>
                <button type="button" class="close" onclick="$('#modalConsultores').modal('hide')"
                    aria-label="Close">
                ...
                <div class="row">
                    ...
                    <div class="card-body modal_font_size row">
                        ...
                        <div class="form-group col-md-4 required">
                            ...
                            <div class="input-group required-valid">
                                <input type="text" class="form-control" placeholder="dd-mm-aaaa"
                                    ...
                                    value="{{ $consultor->fecha_conclusion->format('d-m-Y') }}">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="input-group required-valid">
                                <textarea disabled class="form-control" cols="5" rows="2">{{ $consultor->observacion }}
                                </textarea>
                            </div>
                        </div>
                        <hr
            ...
            <div class="modal-footer">
                <div class="col d-flex justify-content-between">
                    <button type="button" class="btn btn-danger float-left"
                        onclick="$('#modalConsultores').modal('hide')"><i class="fa fa-times"></i> Cancelar</button>
...
@include('asignacion_cargo.consultor.modalNomina')
<script>
