<div class="modal-dialog modal-custom">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">Nuevo Consultor</h5>
        ...
        <div class="modal-body">
            <div class="row">
                <form action="{{ route('consultor.registrar') }}" method="POST" class="create"
                    role="form" id="formNuevoConsultor">
                    @csrf
...
@include('asignacion_cargo.consultor.modalTrabajador')
